...
var DESIRED_GRID_COUNT = 8;
var elements = {
  top: cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('#top'),
  container: cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('#container'),
  grid: cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('#grid'),
  gridPattern: cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('#grid-pattern'),
  right: cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('#right'),
  textarea: cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('#right textarea'),
  img: cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('#img')
};
var gridSize = 200;

function calcGridSize() {
  var containerWidth = elements.container.width();
  gridSize = Math.round(containerWidth / DESIRED_GRID_COUNT);
}

function applyGridSize() {
  if (isNaN(gridSize) || gridSize === Infinity) return;
  var containerWidth = DESIRED_GRID_COUNT * gridSize;
  var textareaHeight = elements.textarea.height();
  var textareaVerticalGridCount = Math.max(Math.ceil(textareaHeight / gridSize), 3);
  var height = (textareaVerticalGridCount + 3) * gridSize + 1;
  elements.top.css({
  ...
  elements.grid.attr({
    viewBox: "0 0 ".concat(containerWidth + gridSize * 2, " ").concat(height)
  }).css({
...
var onResize = (0,widok_throttle__WEBPACK_IMPORTED_MODULE_1__["default"])(33, function () {
  elements.container.css({
    width: 'auto'
  });
  setTimeout(function () {
...
cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(window).on({
  load: onResize,
  resize: onResize
});
